...
export { default as IconEyeClose } from './modals/IconEyeClose';
export { default as IconEye } from './modals/IconEye';
export { default as IconPassword } from './modals/IconPassword';

export { default as IconTop } from './services/IconTop';
export { default as IconCode } from './services/IconCode';
export { default as IconDevices } from './services/IconDevices';
